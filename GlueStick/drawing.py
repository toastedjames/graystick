...
def plot_keypoints(kpts, colors='gray', ps=4, alpha=1):
...
def plot_matches(kpts0, kpts1, color='gray', lw=1.5, ps=4, indices=(0, 1), a=1.):
...
def plot_lines(lines, line_colors='gray', point_colors='white',
